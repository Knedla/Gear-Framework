...
- the user can serialize and deserialize (save/load) only the custom values of the instantiated data class (Gold.CurrentAmount, Ake.CurrentDurability, ...), the rest of the data is stored in the definition object
...
- the namespace format must start with 'Entity'
...
Entity.Example.Definition -> ...\Entity\Example\Definition\*.cs
Entity.Example.Database   -> ...\Entity\Example\Database\*.cs
Entity.Example.Data       -> ...\Entity\Example\Data\*.cs
...
- STEP 1: - Definition namespace - Entity.[optional].Definition
...
- STEP 2: - Database namespace - Entity.[optional].Database

create a CurrenciDatabase class derived from GearFramework.Common.Database<T> and pass in a specific generic type, in this case Definition.Currenci
   -> public class CurrencyDatabaseEg : GearFramework.Common.Database<Definition.Currency>
...
- STEP 3: - Data namespace - Entity.[optional].Data
...
the generic abstract class Currenci<T> needs to load data from the database and will do so with this line of code
