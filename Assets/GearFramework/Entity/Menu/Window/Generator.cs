...
namespace GearFramework.Entity
{
    public class Generator : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            rootVisualElement.Q<Button>(selectDbContextButtonName).RegisterCallback<ClickEvent>(clickEvent => ScriptableObjectUtil.SelectAssetFile(AssetDatabase.LoadAssetAtPath<GameObject>(PathUtil.GetRelativePath(DbContext.GetPrefabFilePath()))));
